...
class woocommerceCustomOverrides
{
    ...
    public function woocommerce_general_overrides()
    {
        ...
        add_action('woocommerce_before_main_content', array($this, 'PROYECTO_woocommerce_custom_wrapper_start'), 10);
        add_action('woocommerce_after_main_content', array($this, 'PROYECTO_woocommerce_custom_wrapper_end'), 10);
    }

    /**
     * Woocommerce main class wrapper - start
     */
    public function PROYECTO_woocommerce_custom_wrapper_start()
    {
     ...
     */
    public function PROYECTO_woocommerce_custom_wrapper_end()
    {
