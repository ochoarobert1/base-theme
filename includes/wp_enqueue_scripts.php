...
function proyecto_load_scripts()
{
    $version_remove = NULL;
    if (!is_admin()) {
        ...
        if (class_exists('WooCommerce')) {
            wp_register_script('main-woocommerce-functions', get_template_directory_uri() . '/js/proyecto-woocommerce.js', array('jquery'), $version_remove, true);
...
add_action('wp_enqueue_scripts', 'proyecto_load_scripts', 1);
